...
.. csv-table:: **dynamics_nml namelist options**
   ...
   "``capping``", "real", "method for capping the viscous coefficients", "1.0"
   "", "``0``", "Kreyscher 2000", ""
   "", "``1``", "Hibler 1979", ""
   ...
   "``deltaminEVP``", "real", "minimum delta for viscous coefficients", "1e-11"
   "``deltaminVP``", "real", "minimum delta for viscous coefficients", "2e-9"
   ...
   "``visc_coeff_method``", "``avg_strength``", "average strength for visc coeff on U grid", "``avg_strength``"
   "", "``avg_zeta``", "average zeta for visc coeff on U grid", ""
...
.. csv-table:: **forcing_nml namelist options**
   ...
   "``ice_data_type``",  "``bigblock``", "uniform ice block covering about 90 percent of the area in center of domain", "``default``"
   "", "``blocke``", "initialize ice concentration on right side of domain with aice=1", ""
   "", "``blockep5``", "initialize ice concentration on right side of domain with aice=0.5", ""
   "", "``boxslotcyl``", "initialize ice concentration and velocity for :ref:`boxslotcyl` test (:cite:`Zalesak79`)", ""
   "", "``box2001``", "initialize ice concentration for :ref:`box2001` test (:cite:`Hunke01`) aice 0 to 1 zonally", ""
   ...
   "", "``medblock``", "uniform ice block covering about 25 percent of the area in center of domain", ""
   "", "``medblocke``", "uniform ice block covering about 25 percent at right side of domain", ""
   "", "``smallblock``", "uniform 2x2 block ice concentration and thickness in center of domain", ""
   "", "``uniform``", "uniform ice concentration and thickness across domain distributed in categories", ""
   "", "``uniformp5``", "uniform ice concentration and thickness across domain with aice=0.5 q", ""
